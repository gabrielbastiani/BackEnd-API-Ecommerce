...
-- CreateTable
CREATE TABLE "atributesproducts" (
    "id" TEXT NOT NULL,
    "product_id" TEXT,
    "tipo" TEXT,
    "created_at" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "atributesproducts_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "atributesproducts_tipo_key" ON "atributesproducts"("tipo");
...
-- AddForeignKey
ALTER TABLE "atributesproducts" ADD CONSTRAINT "atributesproducts_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "atributesproducts" ADD CONSTRAINT "atributesproducts_tipo_fkey" FOREIGN KEY ("tipo") REFERENCES "typeatributes"("tipo") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "atributesproducts" ADD CONSTRAINT "atributesproducts_loja_id_fkey" FOREIGN KEY ("loja_id") REFERENCES "lojas"("id") ON DELETE SET NULL ON UPDATE CASCADE;
