...
-- AddForeignKey
ALTER TABLE "pedidos" ADD CONSTRAINT "pedidos_entrega_id_fkey" FOREIGN KEY ("entrega_id") REFERENCES "entregas"("id") ON DELETE SET NULL ON UPDATE CASCADE;
