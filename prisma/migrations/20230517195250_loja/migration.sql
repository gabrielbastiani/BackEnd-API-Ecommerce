...
-- CreateEnum
CREATE TYPE "StatusTypeAtribute" AS ENUM ('Ativo', 'Inativo');

-- CreateEnum
CREATE TYPE "StatusValueAtribute" AS ENUM ('Ativo', 'Inativo');
...
CREATE TABLE "typeatributes" (
    ...
    "tipo" VARCHAR(385) NOT NULL,
    "order" INTEGER,
    "status" "StatusTypeAtribute" NOT NULL DEFAULT 'Ativo',
    "created_at" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3),
    "loja_id" TEXT,
...
CREATE TABLE "valueatributes" (
    "id" TEXT NOT NULL,
    "product_id" TEXT NOT NULL,
    "typeAtribute_id" TEXT NOT NULL,
    "valor" VARCHAR(385),
    "order" INTEGER,
    "status" "StatusValueAtribute" NOT NULL DEFAULT 'Ativo',
    "created_at" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3),
    "loja_id" TEXT,
...
-- AddForeignKey
ALTER TABLE "typeatributes" ADD CONSTRAINT "typeatributes_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "valueatributes" ADD CONSTRAINT "valueatributes_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "valueatributes" ADD CONSTRAINT "valueatributes_typeAtribute_id_fkey" FOREIGN KEY ("typeAtribute_id") REFERENCES "typeatributes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
