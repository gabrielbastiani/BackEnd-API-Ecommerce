...
CREATE TABLE "filterpages" (
    ...
    CONSTRAINT "filterpages_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "filterpages" ADD CONSTRAINT "filterpages_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "filterpages" ADD CONSTRAINT "filterpages_photoProduct_id_fkey" FOREIGN KEY ("photoProduct_id") REFERENCES "photoproducts"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "filterpages" ADD CONSTRAINT "filterpages_photoProduct_id1_fkey" FOREIGN KEY ("photoProduct_id1") REFERENCES "photoproducts"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "filterpages" ADD CONSTRAINT "filterpages_variacao_id_fkey" FOREIGN KEY ("variacao_id") REFERENCES "variacoes"("id") ON DELETE SET NULL ON UPDATE CASCADE;
