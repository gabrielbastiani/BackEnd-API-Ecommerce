...
-- CreateIndex
CREATE UNIQUE INDEX "groupfilteratributos_nameGroup_key" ON "groupfilteratributos"("nameGroup");

-- CreateIndex
CREATE UNIQUE INDEX "groupfilteratributos_atributoName_key" ON "groupfilteratributos"("atributoName");
...
-- AddForeignKey
ALTER TABLE "relationproductcategories" ADD CONSTRAINT "relationproductcategories_photoProduct_id1_fkey" FOREIGN KEY ("photoProduct_id1") REFERENCES "photoproducts"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "relationproductatributos" ADD CONSTRAINT "relationproductatributos_photoProduct_id_fkey" FOREIGN KEY ("photoProduct_id") REFERENCES "photoproducts"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "relationproductatributos" ADD CONSTRAINT "relationproductatributos_photoProduct_id1_fkey" FOREIGN KEY ("photoProduct_id1") REFERENCES "photoproducts"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "filteratributos" ADD CONSTRAINT "filteratributos_atributoName_fkey" FOREIGN KEY ("atributoName") REFERENCES "groupfilteratributos"("atributoName") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "filtercategories" ADD CONSTRAINT "filtercategories_nameGroup_fkey" FOREIGN KEY ("nameGroup") REFERENCES "groupfilteratributos"("nameGroup") ON DELETE SET NULL ON UPDATE CASCADE;
