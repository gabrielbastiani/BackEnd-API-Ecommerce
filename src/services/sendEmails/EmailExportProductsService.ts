...
class EmailExportProductsService {
    async execute() {
        ...
        const requiredPath = path.join(__dirname, `../store/configurations/emailsTransacionais/emails_transacionais/exportar_produtos.ejs`);
        ...
        await prismaClient.notificationAdmin.create({
            data: {
                message: `Lista de <strong>produtos</strong> enviado com sucesso para o seu email.</strong>.`,
                store_id: store.id
            }
        });
