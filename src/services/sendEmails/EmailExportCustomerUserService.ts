...
class EmailExportCustomerUserService {
    async execute() {
        ...
        const requiredPath = path.join(__dirname, `../store/configurations/emailsTransacionais/emails_transacionais/exportar_clientes.ejs`);
        ...
        await prismaClient.notificationAdmin.create({
            data: {
                message: `Lista de <strong>clientes</strong> enviado com sucesso para o seu email.</strong>.`,
