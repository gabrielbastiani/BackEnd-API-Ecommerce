...
class UpdateNameTemplateEmailOrderStatusService {
    async execute({
        ...
        const updateName = await prismaClient.templateOrderEmail.updateMany({
            where: {
        ...
        const fs = require('fs');
        const nameInPaste = path.join(__dirname, "../../../../src/services/order/templatesEmailsOrderStatus/template_emails_status_order");
...
export { UpdateNameTemplateEmailOrderStatusService }