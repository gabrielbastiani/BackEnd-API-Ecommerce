...
class UpdateNameTemplateEmailFreteOrderStatusService {
    async execute({
        ...
        const updateName = await prismaClient.templateFreteEmail.updateMany({
            where: {
...
export { UpdateNameTemplateEmailFreteOrderStatusService }