...
class FindCategoryRelationBlockService {
    async execute({ product_id }: FindsRequest) {
        ...
        const findFirstDesc = await prismaClient.productCategory.findFirst({
            where: {
        ...
        const findFirstAsc = await prismaClient.productCategory.findFirst({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const findFirstProduct = await prismaClient.productCategory.findFirst({
            where: {
                product_id: product_id
            },
            include: {
        ...
        const allFindDesc = await prismaClient.productCategory.findMany({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const allFindNivelDesc = await prismaClient.productCategory.findMany({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const allFindNivelAsc = await prismaClient.productCategory.findMany({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const findFirstNivelDesc = await prismaClient.productCategory.findFirst({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const findFirstNivelAsc = await prismaClient.productCategory.findFirst({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const findFirstOrderDesc = await prismaClient.productCategory.findFirst({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const findFirstOrderAsc = await prismaClient.productCategory.findFirst({
            where: {
                product_id: product_id
            },
            orderBy: {
        ...
        const allFindOrderDesc = await prismaClient.productCategory.findMany({
            where: {
                product_id: product_id,
                parentId: ""
            },
        ...
        const allFindOrderAsc = await prismaClient.productCategory.findMany({
            where: {
                product_id: product_id,
            },
            orderBy: {
        ...
        const allFindOrderRelationIDAsc = await prismaClient.productCategory.findMany({
            where: {
                product_id: product_id,
                parentId: ""
            },
